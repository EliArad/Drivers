...
using TCA6416Api;
using static TCA6416Api.TCA6416;
...
namespace TCA6416TesterApp
{
    public partial class Form1 : Form
    {
        ...
        {             
                //tca6416.ReadFromRegister(Command.InputPort0);       //Return type should be byte or byte[]            
        }

        private void btnReadFromRegister1_Click(object sender, EventArgs e)
        {             
              //tca6416.ReadFromRegister(Command.InputPort1);       //Return type should be byte or byte[]            
        }
        ...
        private void btnOnOff9_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                tca6416[1].WriteIO(PORTS.PORT0, IO_BITS.BIT0, ledBulb1.On);
            }
            catch (Exception err)
            {
        ...
        private void connectToolStripMenuItem_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                tca6416[0] = new TCA6416(m_i2c, 0x40); // L
                tca6416[1] = new TCA6416(m_i2c, 0x42); // H

                tca6416[0].SetIODirection(PORTS.PORT0, IO_BITS.ALL_BITS);
                tca6416[0].SetIODirection(PORTS.PORT1, IO_BITS.ALL_BITS);
                tca6416[0].WriteIO(PORTS.PORT0, IO_BITS.ALL_BITS, false);
                tca6416[0].WriteIO(PORTS.PORT1, IO_BITS.ALL_BITS, false);

                IO_BITS m_port1Config = IO_BITS.ALL_BITS;
                tca6416[1].SetIODirection(PORTS.PORT0, m_port1Config);

                m_port1Config = m_port1Config & ~IO_BITS.BIT3;                
                tca6416[1].SetIODirection(PORTS.PORT1, m_port1Config);
                tca6416[1].WriteIO(PORTS.PORT0, IO_BITS.ALL_BITS, false);
                tca6416[1].WriteIO(PORTS.PORT1, IO_BITS.ALL_BITS, false);
            }
            catch (Exception err)
            {
                MessageBox.Show(err.Message);
        ...
        private void btnOnOff1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                tca6416[0].WriteIO(PORTS.PORT0, IO_BITS.BIT0, ledBulb32.On);
            }
            catch (Exception err)
            {
                MessageBox.Show(err.Message);
        ...
        private void btnLoadOn10_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                tca6416[1].WriteIO(PORTS.PORT0, IO_BITS.BIT1, ledBulb1.On);
            }
            catch (Exception err)
            {
                MessageBox.Show(err.Message);
        ...
        private void btnSenseCmd_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                tca6416[1].WriteIO(PORTS.PORT0, IO_BITS.BIT2, ledBulb1.On);
            }
            catch (Exception err)
            {
                MessageBox.Show(err.Message);
        ...
        private void btnExtInCmd_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                tca6416[1].WriteIO(PORTS.PORT0, IO_BITS.BIT3, ledBulb1.On);
            }
            catch (Exception err)
            {
                MessageBox.Show(err.Message);
        ...
        private void btnEventOut_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                tca6416[1].WriteIO(PORTS.PORT0, IO_BITS.BIT4, ledBulb8.On);
            }
            catch (Exception err)
            {
                MessageBox.Show(err.Message);
        ...
        private void BtnMcuReset_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                tca6416[1].WriteIO(PORTS.PORT0, IO_BITS.BIT6, ledBulb6.On);
            }
            catch (Exception err)
            {
                MessageBox.Show(err.Message);
        ...
        private void btnPowerOnReset_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                tca6416[1].WriteIO(PORTS.PORT0, IO_BITS.BIT7, ledBulb5.On);
            }
            catch (Exception err)
            {
                MessageBox.Show(err.Message);
        ...
        private void btnBatC1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                tca6416[1].WriteIO(PORTS.PORT1, IO_BITS.BIT0, ledBulb16.On);
            }
            catch (Exception err)
            {
                MessageBox.Show(err.Message);
        ...
        private void btnBatC2_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                tca6416[1].WriteIO(PORTS.PORT1, IO_BITS.BIT1, ledBulb15.On);
            }
            catch (Exception err)
            {
                MessageBox.Show(err.Message);
        ...
        private void btnBatC3_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                tca6416[1].WriteIO(PORTS.PORT1, IO_BITS.BIT2, ledBulb14.On);
            }
            catch (Exception err)
            {
                MessageBox.Show(err.Message);
        ...
        private void btnBatC4_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                tca6416[1].WriteIO(PORTS.PORT1, IO_BITS.BIT3, ledBulb13.On);
            }
            catch (Exception err)
            {
                MessageBox.Show(err.Message);
        ...
        private void btnChargeCmd1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                tca6416[1].WriteIO(PORTS.PORT1, IO_BITS.BIT4, ledBulb12.On);
            }
            catch (Exception err)
            {
                MessageBox.Show(err.Message);
        ...
        private void btnChargeCmd2_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                tca6416[1].WriteIO(PORTS.PORT1, IO_BITS.BIT5, ledBulb11.On);
            }
            catch (Exception err)
            {
                MessageBox.Show(err.Message);
        ...
        private void btnChargeCmd3_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                tca6416[1].WriteIO(PORTS.PORT1, IO_BITS.BIT6, ledBulb10.On);
            }
            catch (Exception err)
            {
                MessageBox.Show(err.Message);
        ...
        private void btnChargeCmd4_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                tca6416[1].WriteIO(PORTS.PORT1, IO_BITS.BIT7, ledBulb9.On);
            }
            catch (Exception err)
            {
                MessageBox.Show(err.Message);
        ...
        private void btnOnOff2_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                tca6416[0].WriteIO(PORTS.PORT0, IO_BITS.BIT1, ledBulb31.On);
            }
            catch (Exception err)
            {
                MessageBox.Show(err.Message);
        ...
        private void btnOnOff3_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                tca6416[0].WriteIO(PORTS.PORT0, IO_BITS.BIT2, ledBulb30.On);
            }
            catch (Exception err)
            {
                MessageBox.Show(err.Message);
        ...
        private void btnOnOff4_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                tca6416[0].WriteIO(PORTS.PORT0, IO_BITS.BIT3, ledBulb29.On);
            }
            catch (Exception err)
            {
                MessageBox.Show(err.Message);
        ...
        private void btnOnOff5_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                tca6416[0].WriteIO(PORTS.PORT0, IO_BITS.BIT4, ledBulb28.On);
            }
            catch (Exception err)
            {
                MessageBox.Show(err.Message);
        ...
        private void btnOnOff6_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                tca6416[0].WriteIO(PORTS.PORT0, IO_BITS.BIT5, ledBulb27.On);
            }
            catch (Exception err)
            {
                MessageBox.Show(err.Message);
        ...
        private void btnOnOff7_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                tca6416[0].WriteIO(PORTS.PORT0, IO_BITS.BIT6, ledBulb26.On);
            }
            catch (Exception err)
            {
                MessageBox.Show(err.Message);
        ...
        private void btnOnOff8_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                tca6416[0].WriteIO(PORTS.PORT0, IO_BITS.BIT7, ledBulb25.On);
            }
            catch (Exception err)
            {
                MessageBox.Show(err.Message);
        ...
        private void btnLoadOn1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                tca6416[0].WriteIO(PORTS.PORT1, IO_BITS.BIT0, ledBulb24.On);
            }
            catch (Exception err)
            {
                MessageBox.Show(err.Message);
        ...
        private void btnLoadOn2_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                tca6416[0].WriteIO(PORTS.PORT1, IO_BITS.BIT1, ledBulb21.On);
            }
            catch (Exception err)
            {
                MessageBox.Show(err.Message);
        ...
        private void btnLoadOn3_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                tca6416[0].WriteIO(PORTS.PORT1, IO_BITS.BIT2, ledBulb22.On);
            }
            catch (Exception err)
            {
                MessageBox.Show(err.Message);
        ...
        private void btnLoadOn4_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                tca6416[0].WriteIO(PORTS.PORT1, IO_BITS.BIT3, ledBulb21.On);
            }
            catch (Exception err)
            {
                MessageBox.Show(err.Message);
        ...
        private void button19_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                tca6416[0].WriteIO(PORTS.PORT1, IO_BITS.BIT4, ledBulb20.On);
            }
            catch (Exception err)
            {
                MessageBox.Show(err.Message);
        ...
        private void btnLoadOn6_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                tca6416[0].WriteIO(PORTS.PORT1, IO_BITS.BIT5, ledBulb19.On);
            }
            catch (Exception err)
            {
                MessageBox.Show(err.Message);
        ...
        private void btnLoadOn7_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                tca6416[0].WriteIO(PORTS.PORT1, IO_BITS.BIT6, ledBulb18.On);
            }
            catch (Exception err)
            {
                MessageBox.Show(err.Message);
        ...
        private void btnLoadOn8_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                tca6416[0].WriteIO(PORTS.PORT1, IO_BITS.BIT7, ledBulb17.On);
            }
            catch (Exception err)
            {
                MessageBox.Show(err.Message);
